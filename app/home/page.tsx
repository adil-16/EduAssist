  ...
  return (
    <>
      ...
      <div className="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32 flex items-center justify-center">
        ...
        >
          <div
            className="aspect-w-1097 aspect-h-845 w-[68.5625rem] bg-gradient-to-tr from-[#ff4694] to-[#776fff] opacity-20"
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            <h2 className="flex items-center justify-center text-2xl font-bold tracking-tight text-white sm:text-5xl">
